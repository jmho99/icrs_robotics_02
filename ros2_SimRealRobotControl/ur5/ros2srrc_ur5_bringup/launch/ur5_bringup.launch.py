...
# Launch file for the ur5 Robot CONTROL BRINGUP in ROS2 Humble:
...
def generate_launch_description():
    ...
    print("")
    print("===== Universal Robots - ur5: Robot Bringup (ros2srrc_ur5_bringup) =====")
    ...
    ros2_controllers_path = os.path.join(
        get_package_share_directory("ros2srrc_ur5_bringup"),
        "config",
        "ur_controllers.yaml",
    )
    ...
    if (EE_no == "true"):
        ...
        MoveInterface = Node(
            ...
            executable="move",
            output="screen",
            parameters=[robot_description, robot_description_semantic, kinematics_yaml, {"use_sim_time": True}, {"ROB_PARAM": "ur5"}, {"EE_PARAM": "none"}, {"ENV_PARAM": "bringup"}],
        )
    ...
    if (EE_robotiq == "true"):
        ...
        MoveInterface = Node(
            ...
            executable="move",
            output="screen",
            parameters=[robot_description, robot_description_semantic, kinematics_yaml, {"use_sim_time": True}, {"ROB_PARAM": "ur5"}, {"EE_PARAM": "robotiq_2f85"}, {"ENV_PARAM": "bringup"}],
        )
        SequenceInterface = Node(
            name="sequence",
            package="ros2srrc_execution",
