...
class RobotPARAM(Node):
    def __init__(self):
        ...
        if (PARAM_ROBOT == "default"):
            ...
            # Check value:
            if (PARAM_ROBOT == "ur5" or PARAM_ROBOT == "ur3"):
                None # do nothing.
            else:
...
def main(args=None):
    ...
    filepath = os.path.join(os.path.expanduser('~'), 'teamproject_2', 'src', 'ros2_SimRealRobotControl', 'ros2srrc_execution', 'programs', PR_NAME + ".txt")
